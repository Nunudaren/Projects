...
public class CartItemDao {
	...
	private CartItem toCartItem(Map<String,Object> map) {
		if(map == null || map.size() == 0) return null; //注意条件的判断
	...
	/**
	 * 按照uid和bid来查询当前用户所购买的这本图书 是否在购物车中存在
	 * @param uid
	 * @param bid
	 * @return
	 * @throws SQLException
	...
	/**
	 * '+'/'-'号update quantity
	 * 1.修改Quantity：updateQuantity(String cartItemId, int quantity)
	 * 2.按cartItemId查询,返回cartItem;
	 * (多表查询)
	 * @param cartItemId
	 * @return
	 * @throws SQLException
	...
	public List<CartItem> loadCartItems(String cartItemIds) throws SQLException {
		...
		/*
		 * 4.MapListHandler查询，并返回List<CartItem>
		 */
