...
<div id="divMain">
  ...
  <div id="divBody">
  <!-- 注意：这里的url value='/UserServlet/'写法不正确，后面不能多“/” -->
  <form action="<c:url value='/UserServlet'/>" method="post" id="registForm">
    ...
    <table id="tableForm">
      <tr>
        ...
        <td class="tdInput">
          <input class="inputClass" type="text" name="loginname" id="loginname" value="${userForm.loginname }"/>
        </td>
        <td class="tdError">
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="password" name="loginpass" id="loginpass" value="${userForm.loginpass }"/>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="password" name="reloginpass" id="reloginpass" value="${userForm.reloginpass }"/>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="text" name="email" id="email" value="${userForm.email }"/>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="text" name="verifyCode" id="verifyCode" value="${userForm.verifyCode }"/>
        </td>
        <td>
