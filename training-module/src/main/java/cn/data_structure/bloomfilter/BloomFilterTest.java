package cn.data_structure.bloomfilter;
...
public class BloomFilterTest {
	...
	private void read(InputStream in){
		...
		try {
			//创建输入流
			reader = new InputStreamReader(in, "UTF-8"); //URL中有中文的话用GBK编码或者写这个参数（因为默认编码是GBK）
	...
	public static void main(String[] args) {
		...
		BloomFilterTest bloomFilterTest = new BloomFilterTest("F:\\Program Files (x86)\\Andy\\workspace\\algorithm\\src\\bloomfilter\\aaa.txt");
