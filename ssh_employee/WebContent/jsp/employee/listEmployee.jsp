...
<body>
	...
	<table cellspacing="0" border="1" class="table1">
		...
		<tbody>
			<tr class="tabtd2">
				<td align="center"><s:property value="#e.enumber"/></td>
				...
				<td align="center"><a href="${pageContext.request.contextPath }/employee_delete.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath }/images/t.png"></a></td>
			</tr>
		</tbody>
		</s:iterator>
	</table>
